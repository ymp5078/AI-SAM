...
def assd(result, reference, voxelspacing=None, connectivity=1):
    ...
    """
    assd = numpy.mean( numpy.concatenate((__surface_distances(result, reference, voxelspacing, connectivity), __surface_distances(reference, result, voxelspacing, connectivity)) ))
    return assd
