...
class PromptEncoder(nn.Module):
    ...
    def _get_batch_size(
        ...
        auto_prompt: Optional[torch.Tensor],
    ...
    def forward(
        ...
        """
        bs = self._get_batch_size(points, auto_prompt, boxes, masks)
        ...
        if points is not None:
            ...
            point_embeddings = self._embed_points(coords, labels, pad=(boxes is None and not use_auto_points))
        ...
        if masks is not None:
            ...
            if auto_prompt is not None and not use_auto_points:
                dense_embeddings = auto_prompt
            else:
